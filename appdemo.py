...
#tt_2 = Experiment.height_ttest(670.84)
#tt_3 = Experiment.height_ttest(777.50)
#tt_4 = Experiment.height_ttest(199.01)
#tt_5 = Experiment.height_ttest(720.98)
#tt_6 = Experiment.height_ttest(854.25)
